...
#ifndef DWB_CONTROLLER__FOOTPRINT_COLLISION_CHECKER_HPP_
#define DWB_CONTROLLER__FOOTPRINT_COLLISION_CHECKER_HPP_
...
#endif  // DWB_CONTROLLER__FOOTPRINT_COLLISION_CHECKER_HPP_